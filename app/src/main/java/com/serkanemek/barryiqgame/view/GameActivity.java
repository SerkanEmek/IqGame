...
import com.serkanemek.barryiqgame.mediaplayer.MyMediaPlayerForBackground;
import com.serkanemek.barryiqgame.mediaplayer.MyMediaPlayerForCorrectAnswer;
import com.serkanemek.barryiqgame.mediaplayer.MyMediaPlayerForLast5Min;
import com.serkanemek.barryiqgame.util.AnimationForKeyboard;
import com.serkanemek.barryiqgame.util.IqGame;
...
public class GameActivity extends AppCompatActivity {
        ...
        try {
            ...
            countDownTimer =   new CountDownTimer(25_000, 1_000) {
                ...
                public void onFinish() {
                    ...
                    dialog.getWindow().setBackgroundDrawableResource(R.drawable.dialogwrong_next_english);
                }
            };
    ...
    private void finalstate(View view){
        ...
        try {
            ...
            if(result == Integer.parseInt(textView_ForIqGame_Result.getText().toString())){
                ...
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.dialogright_next_english);
    ...
    private void toastMessageForWrongAnswers(){
        toastForWrongAnswers = Toast.makeText(this,"-2 Coins.. Wrong Answer, Try Again!",Toast.LENGTH_SHORT);
    }
    ...
    private void toastMessageForChangeQuestion(){
        toastForChangeButton = Toast.makeText(this,"-1 Coins.. New Question",Toast.LENGTH_SHORT);
    }
    ...
    public void homeicon(View view){
        ...
        toastForWrongAnswers.cancel();
        toastForChangeButton.cancel();
        Intent intenttoMainMenu = new Intent(getApplicationContext(), MainActivity.class);
